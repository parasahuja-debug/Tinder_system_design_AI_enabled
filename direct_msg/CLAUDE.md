...
`SESSION_SERVICE_URL` (all default to their compose-network hostnames).
...
# needs auth-service/matcher-service/session-service reachable at their
# default URLs (or override via env) for a real connection to succeed.
```
